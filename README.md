...
Sales-operations analytics workbench (Electron). This commit is a sanitized snapshot of release **109**; see the latest commit on `main` for the full README, screenshots and evaluation report.
