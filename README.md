...
Sales-operations analytics workbench (Electron). This commit is a sanitized snapshot of release **123**; see the latest commit on `main` for the full README, screenshots and evaluation report.
